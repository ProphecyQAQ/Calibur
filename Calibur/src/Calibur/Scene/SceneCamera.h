...
namespace Calibur
{
	...
	public:
		...
		/////////Perspective setting functions/////////
		void SetPerspective(float vertivalFov, float nearClip, float farClip);
		...
		/////////Orthograohics setting functions/////////
