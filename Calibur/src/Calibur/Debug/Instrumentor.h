...
#define HZ_PROFILE 0
	...
	#define HZ_PROFILE_BEGIN_SESSION(name, filepath) ::Calibur::Instrumentor::Get().BeginSession(name, filepath)
	#define HZ_PROFILE_END_SESSION() ::Calibur::Instrumentor::Get().EndSession()
	#define HZ_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Calibur::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Calibur::InstrumentationTimer timer##line(fixedName##line.Data)
